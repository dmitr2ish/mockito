...
class StubTest {
    ...
    @Test
    void testStubbingInTraditionalMockitoStyle() {
    ...
    //test_Given_NewBooks_When_GetNewBooksWithAppliedDiscountIsCalled_Then_NewBooksWithAppliedDiscountIsReturned
    @Test
    @DisplayName("Given - New books, " +
            "When - Get new books with applied discount method is called, " +
    ...
    void test_Given_NewBooks_When_GetNewBooksWithAppliedDiscountIsCalled_Then_NewBooksWithAppliedDiscountIsReturned() {
        //test must contain from 3 section
